...
import { allUsers, createUser, profile } from "../../redux/actions";
...
const CreateUserDashboard = () => {
    ...
    const UserCreateFull = useSelector((state) => state.userCreate);
    ...
    useEffect(() => {
        const token = UserCreateFull.token;
        const tokenId = UserCreateFull.userId;
  ...
  return (
        ...
        <div className={styles.containerFullFullEdit} >
            ...
            <h1 className={styles.titleEditUserFull}>Create User</h1>
            ...
            <div>
                <button type="button" onClick={handlecreateUser} className={styles.buttonEditUserContainerTwo}><span>Create User</span></button>
